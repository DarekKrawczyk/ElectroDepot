...
namespace DesktopClient.Containers
{
    public sealed class SortContainer : IEquatable<SortContainer>
    {
        ...
        /// </summary>
        public SortContainer(string description, IComparer<DetailedPurchaseContainerHolder> comparer)
        {
            Description = description;
            Comparer = comparer;
        }

        public IComparer<DetailedPurchaseContainerHolder> Comparer { get; }
